...
public final class Strings {
     ...
     */
    public static String replace(@NotNull String text, @NotNull String tag, @NotNull String replacement) {
        return StringUtils.replaceOnce(text, tag, replacement);
    }
    ...
    public static String replace(@NotNull String text, @NotNull String tag, @NotNull String @NotNull ... replacements) {
        ...
        for (String replacement : replacements) {
            returned = Strings.replace(returned, tag, replacement);
        }
        return returned;
    }
