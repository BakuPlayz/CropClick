...
public abstract class BaseQuery {
     ...
     */
    protected CompletableFuture<Boolean> baseQueue(@NotNull QueryScheduler scheduler) {
     ...
     */
    protected BaseQuery where(@NotNull String column, @NotNull String operator, @NotNull Object value) {
