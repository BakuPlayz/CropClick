...
import com.github.bakuplayz.cropclick.crops.seeds.ground.BeetrootSeed;
 ...
 * @since 2.0.0
 */
public final class Beetroot extends AbstractGroundCrop {

    public Beetroot(@NotNull CropArguments arguments) {
        super(arguments);
    }
