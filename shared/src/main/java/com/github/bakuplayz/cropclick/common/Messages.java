...
import static com.github.bakuplayz.cropclick.common.Languages.Menu.GENERAL_DISABLED_STATUS;
import static com.github.bakuplayz.cropclick.common.Languages.Menu.GENERAL_ENABLED_STATUS;


/**
 * A utility class for {@link Languages displayed messages} and or {@link String strings}.
 *
 * @author BakuPlayz
 * @version 2.0.0
 * @since 2.0.0
...
public final class Messages {
     ...
     */
    @NotNull
    public static String beautify(@NotNull String message, boolean isUnderscored) {
     ...
     */
    @NotNull
    private static String getLastColor(@NotNull String message) {
        int indexOfColor = message.lastIndexOf('&');
        return indexOfColor == -1 ? "" : message.substring(indexOfColor, indexOfColor + 2);
    }
