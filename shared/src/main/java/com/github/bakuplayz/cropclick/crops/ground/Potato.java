...
import com.github.bakuplayz.cropclick.crops.seeds.ground.PoisonousPotato;
 ...
 * @since 2.0.0
 */
public final class Potato extends AbstractGroundCrop {

    public Potato(@NotNull CropArguments arguments) {
        super(arguments);
    }
