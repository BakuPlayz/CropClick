...
public final class LanguageAPI {
    ...
    public enum Menu {
        ...
        CROPS_ITEM_NAME(Category.CROPS, "itemName", "%name%", "%status%"),
        CROPS_ITEM_DROP_NAME(Category.CROPS, "itemDropName", "%name%"),
        CROPS_ITEM_DROP_VALUE(Category.CROPS, "itemDropValue", "%value%"),
        CROPS_ITEM_PARTICLES(Category.CROPS, "itemParticles", "%status%"),
        CROPS_ITEM_SOUNDS(Category.CROPS, "itemSounds", "%status%"),
        CROPS_ITEM_MMO_EXPERIENCE(Category.CROPS, "itemMMOExperience", "%status%"),
        CROPS_ITEM_JOBS_EXPERIENCE(Category.CROPS, "itemJobsExperience", "%status%"),
        CROPS_ITEM_JOBS_POINTS(Category.CROPS, "itemJobsPoints", "%status%"),
        CROPS_ITEM_JOBS_MONEY(Category.CROPS, "itemJobsMoney", "%status%"),
